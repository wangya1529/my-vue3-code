import {normalize} from "rollup-plugin-typescript2/dist/normalize";
...
export const CREATE_ELEMENT_VODE = Symbol(__DEV__ ? 'createElementVNode' : '')
export const CREATE_COMMENT = Symbol(__DEV__? 'createCommentVNode' : '')
export const CREATE_TEXT = Symbol(__DEV__ ? 'createTextNode' : '')
...
export const TO_HANDLERS = Symbol(__DEV__ ? 'tpHandlers' : '')
...
export const IS_MENO_SAME = Symbol(__DEV__ ? 'isMemoSame': '')
...
export const helperNameMap: any = {
    ...
    [CREATE_ELEMENT_VODE]: 'createElementVNode',
